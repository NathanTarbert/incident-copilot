...
export function CounterController({ count, setCount }: CounterControllerProps) {
  ...
  // Tool to set the incident count to a specific value
  useFrontendTool({
  ...
  // This component doesn't render anything - it just registers the tools
  return null
}
